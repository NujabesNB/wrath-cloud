...
INSERT INTO sys_menu(id, pid, url, type, icon, permissions, sort, del_flag, creator, create_date, updater, update_date) VALUES (1067246875800000048, 1067246875800000047, '', 1, '', 'sys:schedule:page,sys:schedule:info', 0, 0, 1067246875800000001, now(), 1067246875800000001, now());
...
INSERT INTO schedule_job (id, bean_name, params, cron_expression, status, remark, creator, create_date, updater, update_date) VALUES (1067246875800000144, 'testTask', 'wrath', '0 0/30 * * * ?', '1', '有参数测试', 1067246875800000001, now(), 1067246875800000001, now());
