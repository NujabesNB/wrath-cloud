...
INSERT INTO gen_test_data(id, username, real_name, gender, email, notice_type, content, creator, create_date, updater, update_date) VALUES (1067246875800000001, 'sunlightcs', 'Mark', 0, 'wrath_tenant', 0, '<p>WRATH代码生成器！</p>', 1067246875800000001, now(), 1067246875800000001, now());
