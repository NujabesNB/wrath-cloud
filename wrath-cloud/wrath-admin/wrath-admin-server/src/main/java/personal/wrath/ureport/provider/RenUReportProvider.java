...
package personal.wrath.ureport.provider;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.bstek.ureport.provider.report.ReportFile;
import com.bstek.ureport.provider.report.ReportProvider;
import personal.wrath.dao.UReportDataDao;
import personal.wrath.entity.UReportDataEntity;
...
public class RenUReportProvider implements ReportProvider {
    private final static String NAME = "wrath-provider";
    private final static String PREFIX = "wrath-";
